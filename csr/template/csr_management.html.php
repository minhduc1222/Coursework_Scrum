...
<head>
    ...
    <title>CSR Management - CheapDeals</title>
    ...
    <div class="w-full max-w-7xl mx-auto p-2 sm:p-4">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-4 sm:p-6 rounded-lg mb-4 sm:mb-6">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center space-x-2">
                    <span class="hidden sm:inline-block">CSR: <?= htmlspecialchars($_SESSION['csr_name'] ?? 'Agent') ?></span>
                    <a href="../authentication/login.php" class="bg-white bg-opacity-20 px-3 py-1 rounded hover:bg-opacity-30 text-sm">
                        Logout
                    </a>
                </div>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden mb-4 sm:mb-6">
                        ...
                        <div class="mt-2 grid grid-cols-1 sm:grid-cols-2 gap-2">
                            ...
                            <div>
                                ...
                                <div class="font-medium">
                                    <?php if ($customer['Role'] == 1): ?>
                                        <span class="px-2 py-1 bg-blue-100 text-blue-800 rounded-full text-xs">Regular</span>
                                    <?php elseif ($customer['Role'] == 2): ?>
                                        <span class="px-2 py-1 bg-purple-100 text-purple-800 rounded-full text-xs">Premium</span>
                                    <?php elseif ($customer['Role'] == 3): ?>
                                        <span class="px-2 py-1 bg-gold-100 text-gold-800 rounded-full text-xs">VIP</span>
                                    <?php else: ?>
            ...
            <div class="mt-3 border-t border-gray-100 px-4 sm:px-6 py-3">
                ...
                <div class="font-medium">
                    <?php 
                    // Display only last 4 digits of credit card for security
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden mb-4 sm:mb-6">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <?php 
                                    $status = 'Active';
                                    if (!empty($sub['EndDate']) && strtotime($sub['EndDate']) < time()) {
                                        $status = 'Expired';
                                    } elseif (!empty($sub['RenewalStatus'])) {
                                        $status = $sub['RenewalStatus'];
                                    }
            ...
            <div id="recommendations-tab" class="customer-tab-content hidden p-4">
                <?php if (empty($recommended_package)): ?>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    <?php foreach ($recommended_package as $package): ?>
                    <div class="border rounded-lg p-4 hover:shadow-md transition">
                        <div class="flex justify-between items-start">
                            <div>
                                <h3 class="font-medium"><?= htmlspecialchars($package['PackageName']) ?></h3>
                                <p class="text-sm text-gray-600 mt-1"><?= htmlspecialchars($package['Description']) ?></p>
                                ...
                                <?php if (!empty($package['Contract'])): ?>
                                <div class="mt-1 text-xs text-gray-500">
                                    <i class="fas fa-calendar-alt mr-1"></i><?= $package['Contract'] ?> month contract
                                </div>
                                <?php endif; ?>
                            </div>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden mb-4 sm:mb-6">
            ...
            <form id="package-form" method="POST" action="csr_management.php">
                ...
                <div class="p-3 sm:p-6">
                    <!-- Mobile Products (Default Visible) -->
                            ...
                            <div class="product-card border rounded-lg p-3 sm:p-4 cursor-pointer hover:shadow-md transition" 
                                ...
                                <div class="flex justify-between items-start">
                                    <div>
                                        ...
                                        <?php if (!empty($product['FreeMinutes']) || !empty($product['FreeSMS']) || !empty($product['FreeGB'])): ?>
                                        <div class="mt-2 text-xs">
                                ...
                                <div class="mt-3 flex justify-between items-center">
                                    ...
                                    <?php else: ?>
                                    <span class="text-xs text-gray-500"><?= htmlspecialchars($product['specs'] ?? '') ?></span>
                                    <?php endif; ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updatePackageReview() {
                ...
                // Calculate total and check if any items are selected
                let totalPrice = 0;
                let hasItems = false;
                ...
                Object.keys(selectedProducts).forEach(category => {
                    if (selectedProducts[category].length > 0) {
                        ...
                        // Add each product in this category
            ...
            recommendButtons.forEach(button => {
                button.addEventListener('click', function() {
                    ...
                    // Send AJAX request to recommend package
