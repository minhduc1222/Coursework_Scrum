...
<head>
    ...
    <title><?= htmlspecialchars($pageTitle) ?> - CheapDeals</title>
                        ...
                        <?php foreach ($deals as $deal): ?>
                            <div class="bg-white rounded-lg shadow-md overflow-hidden border hover:shadow-lg transition">
                                <div class="p-4">
                                    ...
                                    <div class="flex justify-between items-center">
                                        <span class="text-xl font-bold text-blue-600">£<?= number_format($deal['Price'], 2) ?></span>
                                        <a href="deal_details.php?id=<?= $deal['DealID'] ?>" 
                                           class="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700 transition text-sm">
                                            View Deal
                                        </a>
                                    </div>
